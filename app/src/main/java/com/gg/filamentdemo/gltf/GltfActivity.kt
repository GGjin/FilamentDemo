...
package com.gg.filamentdemo.gltf
...
import com.gg.filamentdemo.databinding.SimpleLayoutBinding
...
class GltfActivity : AppCompatActivity() {
    ...
    private  val binding:SimpleLayoutBinding by lazy { SimpleLayoutBinding.inflate(layoutInflater) }
    ...
    fun loadModelData(message: RemoteServer.ReceivedMessage) {
        ...
        clearStatusText()
        binding.userHint.text = message.label
